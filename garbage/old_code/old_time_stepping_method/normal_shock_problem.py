...
from weno1_boltzmann_time_stepping import weno1_boltzmann_time_stepping
...
if __name__=="__main__":
    ...
    save_freq = 50 # Frequency at which the state of the system is saved
    ...
    dx = xb[1] - xb[0]
    dt = 0.5*dx/v # ensuring that the method satisfies the CFL condition
    ...
    save_data = weno1_boltzmann_time_stepping(f,p,u1,u2,T,pL,pR,uL,uR,TL,TR,v,C,n,dt,dx,Nv,R,Lv,Ntheta,V1,V2,v_grid,x_grid,save_me,save_freq)
