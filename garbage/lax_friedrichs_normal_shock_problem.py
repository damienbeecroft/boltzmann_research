...
from lax_friedrichs_weno1_boltzmann import weno1_boltzmann
...
if __name__=="__main__":
    ...
    Nx = 1000 # The resolution of the spatial grid
    ...
    save_data = weno1_boltzmann(f,p,u1,u2,T,pL,pR,uL,uR,TL,TR,v,C,n,dx,Nv,R,Lv,Ntheta,V1,V2,v_grid,x_grid,save_me,save_freq)
